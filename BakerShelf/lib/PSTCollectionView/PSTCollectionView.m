...
@interface PSTCollectionView () <UIScrollViewDelegate> {
    ...
    NSMutableDictionary *__weak _allVisibleViewsDict;
...
@property (weak, nonatomic, readonly) id currentUpdate;
@property (weak, nonatomic, readonly) NSDictionary *visibleViewsDict;
